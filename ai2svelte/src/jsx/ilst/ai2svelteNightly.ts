...
//     svg_id_prefix: "svg-", // Prefix SVG ids with a string to disambiguate from other ids on the page
...
//         frame.parent.name.split(":")[1] == "snippet" ? true : false;
...
//     var snippetSettings = doc.textFrames.getByName('snippet-settings').contents;
...
//   function parseSnippetSettings(settingsText) {
//     // Handle both Windows (\r\n) and Unix (\n) line endings\
...
//       if(doc.layers[i].name.match(new RegExp(/.*:snippet/))) {
...
//     svelteJS +=
//       "let { assetsPath = '/', onAiMounted = () => {}";

//       if(docSettings.snippetProps.length) {
//         svelteJS += ", " + docSettings.snippetProps.join(", ");
//       }
