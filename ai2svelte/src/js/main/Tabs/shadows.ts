const shadows = [
	...
	},
	{
		...
		shadow: '0px 0px 3px rgba(0,0,0,1), 0px 0px 3px rgba(0,0,0,1), 0px 0px 3px rgba(0,0,0,1);',
		id: 'Cheddar'
	},
	{
		source: 'https://meet.google.com/ ',
		shadow: '0 1px 2px rgba(0,0,0,0.6), 0 0 2px rgba(0,0,0,0.3);',
		id: 'Parmesan'
	},
	{
		shadow: '0px 0px 1px rgba(0,0,0,1), 0px 0px 2px rgba(0,0,0,1), 0px 0px 3px rgba(0,0,0,1), 0px 0px 4px rgba(0,0,0,1);',
	...
	},
	{
		...
		shadow: '0 0 2px rgba(0,0,0,1), 0 0 2px rgba(0,0,0,0.8), 0 0 2px rgba(0,0,0,0.5);',
		id: 'Roquefort'
	},
	{
		source: 'https://www.bloomberg.com/graphics/2021-palm-oil-deforestation-climate-change/ ',
		shadow:
			'rgba(0,0,0,1) 1px 0px 0px, rgba(0,0,0,1) 0.540302px 0.841471px 0px, rgba(0,0,0,1) -0.416147px 0.909297px 0px, rgba(0,0,0,1) -0.989992px 0.14112px 0px, rgba(0,0,0,1) -0.653644px -0.756802px 0px, rgba(0,0,0,1) 0.283662px -0.958924px 0px, rgba(0,0,0,1) 0.96017px -0.279415px 0px;',
		id: 'Manchego'
	},
	{
		source: 'https://projects.propublica.org/toxmap/ ',
		shadow: '0 0 10px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,1);',
		id: 'Mozzarella'
	},
	{
		source:
		...
		shadow: '-1px 0 rgba(0,0,0,1), 0 1px rgba(0,0,0,1), 1px 0 rgba(0,0,0,1), 0 -1px rgba(0,0,0,1);',
		id: 'Emmental'
	},
	{
		source:
			'https://www.nytimes.com/interactive/2020/09/24/climate/fires-worst-year-california-oregon-washington.html ',
		shadow: 'rgba(0,0,0,1) 0px 0px 3px, rgba(0,0,0,1) 0px 0px 3px;',
		id: 'Gorgonzola'
	},
	{
		source:
			'https://www.nytimes.com/interactive/2020/07/18/world/asia/china-india-border-conflict.html ',
		shadow: '0 0 10px #00000080, 0 0 3px #000000;',
		id: 'Feta'
	},
	{
		source: 'https://www.nytimes.com/interactive/2019/07/19/us/california-earthquakes.html ',
		shadow:
			'1px 1px 0px rgba(0,0,0,0.7), 0px 1px 0px rgba(0,0,0,0.7), -1px 1px 0px rgba(0,0,0,0.7), -1px 0px 0px rgba(0,0,0,0.7), -1px -1px 0px rgba(0,0,0,0.7), 0px -1px 0px rgba(0,0,0,0.7), 1px -1px 0px rgba(0,0,0,0.7);',
		id: 'Provolone'
	},
	{
	...
	},
	{
		...
		shadow:
			'rgba(0,0,0,0.3) 0.5px 0px 0px, rgba(0,0,0,0.3) 0.540302px 0.841471px 0px, rgba(0,0,0,0.3) -0.416147px 0.909297px 0px, rgba(0,0,0,0.3) -0.989992px 0.14112px 0px, rgba(0,0,0,0.3) -0.653644px -0.756802px 0px, rgba(0,0,0,0.3) 0.283662px -0.958924px 0px, rgba(0,0,0,0.3) 0.96017px -0.279415px 0px;',
		id: 'Asiago'
	},
	{
		source: 'https://www.nytimes.com/interactive/2020/10/03/us/rose-garden-event-covid.html ',
		shadow:
			'1px 1px 3px rgba(0,0,0,0.3), -1px 1px 3px rgba(0,0,0,0.3), 1px -1px 3px rgba(0,0,0,0.3), -1px -1px 3px rgba(0,0,0,0.3);',
		id: 'Edam'
	},
	{
	...
	},
	{
		...
		shadow: '-2px 2px 6px rgba(0,0,0,1), 0 0 2px rgba(0,0,0,1), 2px 2px 6px rgba(0,0,0,1);',
		id: 'Fontina'
	},
	{
		source:
		...
		shadow:
			'1px 1px 1px rgba(0,0,0,0.3), -1px 1px 1px rgba(0,0,0,0.3), 1px -1px 1px rgba(0,0,0,0.3), -1px -1px 1px rgba(0,0,0,0.3), 2px 2px 2px rgba(0,0,0,0.3), -2px 2px 2px rgba(0,0,0,0.3), 2px -2px 2px rgba(0,0,0,0.3), -2px -2px 2px rgba(0,0,0,0.3);',
		id: 'Monterey Jack'
	},
	{
		source:
			'https://www.nytimes.com/interactive/2020/02/01/us/politics/democratic-presidential-campaign-donors.html ',
		shadow: '0px 0px 3px rgba(0,0,0,1), 0px 0px 5px rgba(0,0,0,1), 0px 0px 10px rgba(0,0,0,1);',
		id: 'Ricotta'
	},
	{
		source:
			'https://www.nytimes.com/interactive/2019/06/18/upshot/cities-across-america-question-single-family-zoning.html ',
		shadow: '0 1px 0 rgba(0,0,0,1), 1px 0 0 rgba(0,0,0,1), 0 -1px 0 rgba(0,0,0,1), -1px 0 0 rgba(0,0,0,1) !important;',
		id: 'Stilton'
	},
	{
		source:
			'https://www.nytimes.com/interactive/2019/03/11/world/boeing-737-max-which-airlines.html ',
		shadow: '0px 0px 5px rgba(0,0,0,1), 0px 0px 5px rgba(0,0,0,1);',
		id: 'Taleggio'
	},
	{
		source: 'https://www.nytimes.com/interactive/2020/09/21/us/covid-schools.html ',
		shadow: '1px -1px 0 rgba(0,0,0,1), 1px -1px 0 rgba(0,0,0,1), -1px 1px 0 rgba(0,0,0,1), 1px 1px 0 rgba(0,0,0,1);',
		id: 'Cotija'
	},
	{
		source: 'https://www.nytimes.com/2022/02/07/us/tsunami-northwest-evacuation-towers.html',
		shadow: '0px 0px 2px rgba(0,0,0,1);',
		id: 'Halloumi'
	},
	{
		source: 'https://www.washingtonpost.com/graphics/2017/national/harvey/ ',
		shadow:
			'1px 1px 0px rgba(0,0,0,0.7), -1px -1px 0px rgba(0,0,0,0.7), -1px 1px 0px rgba(0,0,0,0.7), 1px -1px 0px rgba(0,0,0,0.7);',
		id: 'Pecorino'
	},
	{
	...
	{
		shadow:
			'rgba(0,0,0,1) 1px 0px 0px,rgba(0,0,0,1) .5px .8px 0px,rgba(0,0,0,1) -.4px .9px 0px,rgba(0,0,0,1) -.98px .14px 0px,rgba(0,0,0,1) -.65px -.75px 0px,rgba(0,0,0,1) .28px -.95px 0px,rgba(0,0,0,1) .96px -.27px 0px;',
		source:
	...
	},
	{
		...
		shadow: '1px 1px 0px rgba(0,0,0,1),-1px 1px 0px rgba(0,0,0,1),1px -1px 0px rgba(0,0,0,1),-1px -1px 0px rgba(0,0,0,1);',
		id: 'Pecorino II'
	}
];
...
const shadowsLocal = [
	...
	},
	{
		source:
			'https://www.nytimes.com/interactive/2021/09/15/nyregion/empire-state-building-reopening-new-york.html ',
		shadow:
			'1px 1px 1px #000000E6, 1px -1px 1px #000000E6, -1px 1px 1px #000000E6, -1px -1px 1px #000000E6;',
		id: 'Gouda'
	},
	{
		source: 'https://www.nytimes.com/interactive/2021/12/11/us/tornado-maps-damage.html ',
	...
	{
		source: 'https://meet.google.com/ ',
		shadow: '0 1px 2px #00000099, 0 0 2px #0000004D;',
		id: 'Parmesan'
	},
	{
	...
	{
		source: 'https://www.bloomberg.com/graphics/2021-palm-oil-deforestation-climate-change/ ',
		shadow: '0 0 2px #000000, 0 0 2px #000000CC, 0 0 2px #00000080;',
		id: 'Roquefort'
	},
	{
		source: 'https://www.bloomberg.com/graphics/2021-palm-oil-deforestation-climate-change/ ',
	...
	},
	{
		source: 'https://www.nytimes.com/interactive/2019/07/19/us/california-earthquakes.html ',
		shadow:
			'1px 1px 0px #000000B3, 0px 1px 0px #000000B3, -1px 1px 0px #000000B3, -1px 0px 0px #000000B3, -1px -1px 0px #000000B3, 0px -1px 0px #000000B3, 1px -1px 0px #000000B3;',
		id: 'Provolone'
	},
	{
		source: 'https://www.nytimes.com/interactive/2019/09/11/us/midwest-flooding.html ',
		shadow: '0 0 4px #000000B3;',
		id: 'Havarti'
	},
	{
		source:
	...
	},
	{
		source:
			'https://www.nytimes.com/interactive/2020/08/04/world/middleeast/beirut-explosion-damage.html ',
		shadow:
			'#0000004D 0.5px 0px 0px, #0000004D 0.540302px 0.841471px 0px, #0000004D -0.416147px 0.909297px 0px, #0000004D -0.989992px 0.14112px 0px, #0000004D -0.653644px -0.756802px 0px, #0000004D 0.283662px -0.958924px 0px, #0000004D 0.96017px -0.279415px 0px;',
		id: 'Asiago'
	},
	{
		source: 'https://www.nytimes.com/interactive/2020/10/03/us/rose-garden-event-covid.html ',
		shadow:
			'1px 1px 3px #0000004D, -1px 1px 3px #0000004D, 1px -1px 3px #0000004D, -1px -1px 3px #0000004D;',
		id: 'Edam'
	},
	{
		source: 'https://graphics.reuters.com/AFGHANISTAN-CONFLICT/KABUL-AIRPORT/movannkgkpa/ ',
		shadow:
			'1px 1px 1px #000000B3, -1px -1px 1px #000000B3, 1px -1px 1px #000000B3, -1px 1px 1px #000000B3;',
		id: 'Colby'
	},
	{
		source: 'https://www.washingtonpost.com/nation/interactive/2021/weather-disasters-2021 ',
	...
	},
	{
		source:
			'https://www.nytimes.com/interactive/2020/06/03/us/minneapolis-police-use-of-force.html ',
		shadow:
			'1px 1px 1px #0000004D, -1px 1px 1px #0000004D, 1px -1px 1px #0000004D, -1px -1px 1px #0000004D, 2px 2px 2px #0000004D, -2px 2px 2px #0000004D, 2px -2px 2px #0000004D, -2px -2px 2px #0000004D;',
		id: 'Monterey Jack'
	},
	{
		source:
	...
	},
	{
		source: 'https://www.washingtonpost.com/graphics/2017/national/harvey/ ',
		shadow:
			'1px 1px 0px #000000B3, -1px -1px 0px #000000B3, -1px 1px 0px #000000B3, 1px -1px 0px #000000B3;',
		id: 'Pecorino'
	},
	{
		shadow: '1px 1px 2px #00000080;',
		source: 'https://graphics.reuters.com/CHINA-CRASH/akpezjzxlvr/index.html',
		id: 'Burrata'
	},
	{
