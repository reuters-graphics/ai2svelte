...
<script>
	let { assetsPath = '/', onAiMounted = () => {}, onArtboardChange = () => {}, ripple, bitcoin, ethereum } = $props();
...
<div id="g-stock-box" class="ai2svelte" bind:this={aiBox} bind:clientWidth={aiBoxWidth}>
	...
	<div id="g-stock-sm" class="g-artboard" style="max-width: 659px;aspect-ratio: 1.30345154818619;" data-aspect-ratio="1.303" data-min-width="0" data-max-width="659">
		<div id="g-stock-sm-img" class="g-stock-sm-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/stock-sm.png);"></div>		<div id="g-ai0-29" class="g-artwork g-aiAbs g-aiPointText" style="top:83.446%;margin-top:-7.5px;left:77.5845%;margin-left:-18px;width:36px;">
...
{@render ethereum?.()}
	...
	<div id="g-stock-md" class="g-artboard" style="min-width: 660px;aspect-ratio: 1.73106191194952;" data-aspect-ratio="1.731" data-min-width="660">
		<div id="g-stock-md-img" class="g-stock-md-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/stock-md.png);"></div>		<div id="g-ai1-29" class="g-artwork g-aiAbs g-aiPointText" style="top:84.8477%;margin-top:-7.5px;left:77.4838%;margin-left:-18px;width:36px;">
			<p class="g-pstyle4">Jul</p>
		</div>
