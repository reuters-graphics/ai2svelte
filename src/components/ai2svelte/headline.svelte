...
<script>
	let { assetsPath = '/', onAiMounted = () => {}, onArtboardChange = () => {}, hed } = $props();
...
<div id="g-headline-box" class="ai2svelte" bind:this={aiBox} bind:clientWidth={aiBoxWidth}>
	...
	<div id="g-headline-xs" class="g-artboard" style="max-width: 509px;aspect-ratio: 0.44042935462097;" data-aspect-ratio="0.44" data-min-width="0" data-max-width="509">
		<div id="g-headline-xs-img" class="g-headline-xs-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/headline-xs.png);"></div>		<div class="g-snippet-layer g-hed">
...
{@render hed?.()}
	...
	<div id="g-headline-sm" class="g-artboard" style="min-width: 510px;max-width: 659px;aspect-ratio: 0.57805508469061;" data-aspect-ratio="0.578" data-min-width="510" data-max-width="659">
		<div id="g-headline-sm-img" class="g-headline-sm-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/headline-sm.png);"></div>		<div class="g-snippet-layer g-hed">
...
{@render hed?.()}
	...
	<div id="g-headline-md" class="g-artboard" style="min-width: 660px;max-width: 929px;aspect-ratio: 0.77989399349069;" data-aspect-ratio="0.78" data-min-width="660" data-max-width="929">
		<div id="g-headline-md-img" class="g-headline-md-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/headline-md.png);"></div>		<div class="g-snippet-layer g-hed">
...
{@render hed?.()}
	...
	<div id="g-headline-lg" class="g-artboard" style="min-width: 930px;max-width: 1199px;aspect-ratio: 1.41065361623927;" data-aspect-ratio="1.411" data-min-width="930" data-max-width="1199">
		<div id="g-headline-lg-img" class="g-headline-lg-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/headline-lg.png);"></div>		<div class="g-snippet-layer g-hed">
...
{@render hed?.()}
	...
	<div id="g-headline-xl" class="g-artboard" style="min-width: 1200px;aspect-ratio: 1.46520146520147;" data-aspect-ratio="1.465" data-min-width="1200">
		<div id="g-headline-xl-img" class="g-headline-xl-img g-aiImg" alt="" style="background-image: url({ assetsPath.replace(new RegExp('/([^/.]+)$'), '/$1/') || '/' }images/graphics/headline-xl.png);"></div>		<div class="g-snippet-layer g-hed">
