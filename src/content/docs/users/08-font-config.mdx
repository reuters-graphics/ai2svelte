...
import Missing_Font_Message from "../../../../public/images/missing_font_message.png";
import Custom_Fonts from "../../../../public/images/custom_fonts.png";
...
<Image
  src={Missing_Font_Message}
  alt="Screenshot showing success message post ai2svelte export"
/>
...
{/* prettier-ignore */}
<Steps>
  1. Navigate to the `Settings` tab in the ai2svelte panel. 
  2. Locate the `Font Configuration` section. 
  3. Add your custom font mappings using the format
  shown below:
</Steps>
...
<Image
  class="plugin-image"
  src={Custom_Fonts}
  alt="Screenshot showing custom font configuration panel"
/>
